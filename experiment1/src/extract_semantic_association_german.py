"""
Extract semantic association from linguistic data from German corpora
"""
...
if __name__ == "__main__":
    corpora = [
        {
            "df": pd.read_excel(Path("experiment1", "data", "delogu_2019_stim.xlsx")),
            "out_path": Path(
    ...
    config = [
        ...
        },
        {
            "implementation": "WE",
            "model_type": "WordEmbedding",
            "model_name": "dewiki_20180420_300d",
        },
        {
            "implementation": "CWE",
